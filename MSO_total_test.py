...
if __name__ == '__main__':
    ...
    for i in range(10, 40, 2):
        for j in range(2 ,30, 2):
            ...
            #训练集的数据保存
            pd.DataFrame(BLS_predictTrain.reshape(-1,1)).to_csv("E:\\yan_2\\CFBLS_LCFBLS复现\\result\\csvFile\\MSO\\BLS\\train\\BLS_mapping_{}_enhance_{}.csv".format(i, j), index=False)
            pd.DataFrame(CFBLS_predictTrain.reshape(-1,1)).to_csv(
                "E:\\yan_2\\CFBLS_LCFBLS复现\\result\\csvFile\\MSO\\CFBLS\\train\\CFBLS_mapping_{}_enhance_{}.csv".format(i, j),
                index=False)
            pd.DataFrame(LCFBLS_predictTrain.reshape(-1,1)).to_csv(
                "E:\\yan_2\\CFBLS_LCFBLS复现\\result\\csvFile\\MSO\\LCFBLS\\train\\LCFBLS_mapping_{}_enhance_{}.csv".format(i, j),
                index=False)
            pd.DataFrame(CEBLS_predictTrain.reshape(-1,1)).to_csv(
                "E:\\yan_2\\CFBLS_LCFBLS复现\\result\\csvFile\\MSO\\CEBLS\\train\\CEBLS_mapping_{}_enhance_{}.csv".format(i, j),
                index=False)

            pd.DataFrame(BLS_ESN_predictTrain.reshape(-1,1)).to_csv(
                "E:\\yan_2\\CFBLS_LCFBLS复现\\result\\csvFile\\MSO\\BLS_ESN\\train\\BLS_ESN_mapping_{}_enhance_{}.csv".format(i, j),
                index=False)
            pd.DataFrame(CFBLS_ESN_predictTrain.reshape(-1,1)).to_csv(
                "E:\\yan_2\\CFBLS_LCFBLS复现\\result\\csvFile\\MSO\\CFBLS_ESN\\train\\CFBLS_ESN_mapping_{}_enhance_{}.csv".format(i, j),
                index=False)
            pd.DataFrame(LCFBLS_ESN_predictTrain.reshape(-1,1)).to_csv(
                "E:\\yan_2\\CFBLS_LCFBLS复现\\result\\csvFile\\MSO\\LCFBLS_ESN\\train\\LCFBLS_ESN_mapping_{}_enhance_{}.csv".format(i, j),
                index=False)

            # 测试集的数据保存
            pd.DataFrame(BLS_predictTest.reshape(-1,1)).to_csv(
                "E:\\yan_2\\CFBLS_LCFBLS复现\\result\\csvFile\\MSO\\BLS\\test\\BLS_mapping_{}_enhance_{}.csv".format(i, j),
                index=False)
            pd.DataFrame(CFBLS_predictTest.reshape(-1,1)).to_csv(
                "E:\\yan_2\\CFBLS_LCFBLS复现\\result\\csvFile\\MSO\\CFBLS\\test\\CFBLS_mapping_{}_enhance_{}.csv".format(i, j),
                index=False)
            pd.DataFrame(LCFBLS_predictTest.reshape(-1,1)).to_csv(
                "E:\\yan_2\\CFBLS_LCFBLS复现\\result\\csvFile\\MSO\\LCFBLS\\test\\LCFBLS_mapping_{}_enhance_{}.csv".format(
                    i, j),
                index=False)
            pd.DataFrame(CEBLS_predictTest.reshape(-1,1)).to_csv(
                "E:\\yan_2\\CFBLS_LCFBLS复现\\result\\csvFile\\MSO\\CEBLS\\test\\CEBLS_mapping_{}_enhance_{}.csv".format(i, j),
                index=False)

            pd.DataFrame(BLS_ESN_predictTest.reshape(-1,1)).to_csv(
                "E:\\yan_2\\CFBLS_LCFBLS复现\\result\\csvFile\\MSO\\BLS_ESN\\test\\BLS_ESN_mapping_{}_enhance_{}.csv".format(
                    i, j),
                index=False)
            pd.DataFrame(CFBLS_ESN_predictTest.reshape(-1,1)).to_csv(
                "E:\\yan_2\\CFBLS_LCFBLS复现\\result\\csvFile\\MSO\\CFBLS_ESN\\test\\CFBLS_ESN_mapping_{}_enhance_{}.csv".format(
                    i, j),
                index=False)
            pd.DataFrame(LCFBLS_ESN_predictTest.reshape(-1,1)).to_csv(
                "E:\\yan_2\\CFBLS_LCFBLS复现\\result\\csvFile\\MSO\\LCFBLS_ESN\\test\\LCFBLS_ESN_mapping_{}_enhance_{}.csv".format(
                    i, j),
                index=False)
    ...
    pd.DataFrame(BLS_Train_datafram).to_csv(
        'E:\\yan_2\\CFBLS_LCFBLS复现\\result\\zhibiao\\BLS\\MSO\\train\\BLS_train.csv', index=False)
    ...
    pd.DataFrame(BLS_Test_datafram).to_csv(
        'E:\\yan_2\\CFBLS_LCFBLS复现\\result\\zhibiao\\BLS\\MSO\\test\\BLS_test.csv', index=False)
    ...
    pd.DataFrame(CFBLS_Train_datafram).to_csv(
        'E:\\yan_2\\CFBLS_LCFBLS复现\\result\\zhibiao\\CFBLS\\MSO\\train\\CFBLS_train.csv', index=False)
    ...
    pd.DataFrame(CFBLS_Test_datafram).to_csv(
        'E:\\yan_2\\CFBLS_LCFBLS复现\\result\\zhibiao\\CFBLS\\MSO\\test\\CFBLS_test.csv', index=False)
    ...
    pd.DataFrame(LCFBLS_Train_datafram).to_csv(
        'E:\\yan_2\\CFBLS_LCFBLS复现\\result\\zhibiao\\LCFBLS\\MSO\\train\\LCFBLS_train.csv', index=False)
    ...
    pd.DataFrame(LCFBLS_Test_datafram).to_csv(
        'E:\\yan_2\\CFBLS_LCFBLS复现\\result\\zhibiao\\LCFBLS\\MSO\\test\\LCFBLS_test.csv', index=False)
    ...
    pd.DataFrame(CEBLS_Train_datafram).to_csv(
        'E:\\yan_2\\CFBLS_LCFBLS复现\\result\\zhibiao\\CEBLS\\MSO\\train\\CEBLS_train.csv', index=False)
    ...
    pd.DataFrame(CEBLS_Test_datafram).to_csv(
        'E:\\yan_2\\CFBLS_LCFBLS复现\\result\\zhibiao\\CEBLS\\MSO\\test\\CEBLS_test.csv', index=False)
    ...
    pd.DataFrame(BLS_ESN_Train_datafram).to_csv(
        'E:\\yan_2\\CFBLS_LCFBLS复现\\result\\zhibiao\\BLS_ESN\\MSO\\train\\BLS_ESN_train.csv', index=False)
    ...
    pd.DataFrame(BLS_ESN_Test_datafram).to_csv(
        'E:\\yan_2\\CFBLS_LCFBLS复现\\result\\zhibiao\\BLS_ESN\\MSO\\test\\BLS_ESN_test.csv', index=False)
    ...
    pd.DataFrame(CFBLS_ESN_Train_datafram).to_csv(
        'E:\\yan_2\\CFBLS_LCFBLS复现\\result\\zhibiao\\CFBLS_ESN\\MSO\\train\\CFBLS_ESN_train.csv', index=False)
    ...
    pd.DataFrame(CFBLS_ESN_Test_datafram).to_csv(
        'E:\\yan_2\\CFBLS_LCFBLS复现\\result\\zhibiao\\CFBLS_ESN\\MSO\\test\\CFBLS_ESN_test.csv', index=False)
    ...
    pd.DataFrame(LCFBLS_ESN_Train_datafram).to_csv(
        'E:\\yan_2\\CFBLS_LCFBLS复现\\result\\zhibiao\\LCFBLS_ESN\\MSO\\train\\LCFBLS_ESN_train.csv', index=False)
    ...
    pd.DataFrame(LCFBLS_ESN_Test_datafram).to_csv(
        'E:\\yan_2\\CFBLS_LCFBLS复现\\result\\zhibiao\\LCFBLS_ESN\\MSO\\test\\LCFBLS_ESN_test.csv', index=False)
    ...
    pd.DataFrame(dataframTest).to_csv(
        'E:\\yan_2\\CFBLS_LCFBLS复现\\result\\zhibiao\\huizong\\MSO\\huizong_test.csv', index=False)
    ...
    pd.DataFrame(dataframTrain).to_csv(
        'E:\\yan_2\\CFBLS_LCFBLS复现\\result\\zhibiao\\huizong\\MSO\\huizong_train.csv', index=False)
    ...
    pd.DataFrame(dataframTrain_RMSE_TIME).to_csv(
        'E:\\yan_2\\CFBLS_LCFBLS复现\\result\\zhibiao\\huizong\\MSO\\huizong_train_RMSE_TIME.csv', index=False)
    ...
    pd.DataFrame(dataframTest_RMSE_TIME).to_csv(
        'E:\\yan_2\\CFBLS_LCFBLS复现\\result\\zhibiao\\huizong\\MSO\\huizong_test_RMSE_TIME.csv', index=False)
