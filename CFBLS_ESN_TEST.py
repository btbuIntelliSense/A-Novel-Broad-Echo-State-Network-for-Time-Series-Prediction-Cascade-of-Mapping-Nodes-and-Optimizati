...
if __name__ == '__main__':
    ...
    CFBLS_ESN_predictTrain, CFBLS_ESN_predictTest = CFBLS_ESN(traindata, trainlabel, testdata, testlabel, s=0.8, c=2 ** -28, N1=20,N2=20,N3=10)
    ...
    CFBLS_ESN_TrainRMSE = getRMSE(CFBLS_ESN_predictTrain, trainlabel)
    CFBLS_ESN_TestRMSE = getRMSE(CFBLS_ESN_predictTest, testlabel)
    ...
    print("CFBLS_ESN_TrainRMSE : ", CFBLS_ESN_TrainRMSE)
    print("CFBLS_ESN_TestRMSE", CFBLS_ESN_TestRMSE)
    ...
    plt.plot(x, CFBLS_ESN_predictTest, color='#92D050', label='CFBLS_ESN')
