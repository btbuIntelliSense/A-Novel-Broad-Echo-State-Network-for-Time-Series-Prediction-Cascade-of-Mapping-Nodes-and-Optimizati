...
def LCFBLS_ESN(train_x, train_y, test_x, test_y, s, c, N1, N2, N3):
    ...
    for i in range(N3):
        ...
        lmbd = 2 ** -28  # regularization coefficient
        initLen = 100
    ...
    # print("LCFBLS_ESN : ",InputOfOutputLayerTest.shape)
